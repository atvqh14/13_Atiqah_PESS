...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2021 at 02:11 PM
...
--
-- Table structure for table `disptach`
--

CREATE TABLE `disptach` (
...
--
-- Dumping data for table `disptach`
--

INSERT INTO `disptach` (`incident_id`, `patrolcar_id`, `time_dispatched`, `time_arrived`, `time_completed`) VALUES
(0, 'QQX1111A', '2021-03-10 00:40:44', '2021-03-10 15:59:32', '0000-00-00 00:00:00');
...
(0, 'David', '91234567', '010', 'CCK', 'Fire at CCK', '1', '2021-03-09 20:17:27');
...
--
-- Indexes for table `disptach`
--
ALTER TABLE `disptach`
...
--
-- Constraints for table `disptach`
--
ALTER TABLE `disptach`
  ADD CONSTRAINT `disptach_ibfk_1` FOREIGN KEY (`patrolcar_id`) REFERENCES `patrolcar` (`patrolcar_id`),
  ADD CONSTRAINT `disptach_ibfk_2` FOREIGN KEY (`incident_id`) REFERENCES `incident` (`incident_id`);
